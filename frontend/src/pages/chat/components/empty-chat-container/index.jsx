...
function EmptyChatContainer() {
  return (
    <div className="flex-1 md:flex flex-col items-center justify-center hidden duration-1000 transition-all">
      <DotLottieReact
      ...
      <div className="text-center mt-8 space-y-2">
        <h3 className="font-poppins text-3xl font-semibold text-[#1b1c24]">
